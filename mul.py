...
with open('lists/imgs_MSRC.lst') as f:
...
#	print test_lst[idx],test_lst2[idx],test_lst3[idx]
	...
	if not os.path.exists('/home/timplex/caffe_dss/examples/DSS/res_MSRC/' + iname + '.png'):continue
	img2 = Image.open('/home/timplex/caffe_dss/examples/DSS/res_MSRC/' + iname + '.png')
	...
	# load gt
	gt = Image.open(test_lst[idx].replace('images','groundtruth')[:-4]+'.bmp')#
	...
	out_lst = [so, img1, img2, res, gt]
	name_lst = ['Source', 'img1', 'img2', 'mul', 'GT']
